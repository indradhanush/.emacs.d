;;; heaven-and-hell-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
And vise-versa." t nil)

(autoload 'heaven-and-hell-load-default-theme "heaven-and-hell" "\
Disable all custom themes e.g. load default Emacs theme." t nil)

(autoload 'heaven-and-hell-init-hook "heaven-and-hell" "\
Add this to `after-init-hook' so it can load your theme/s of choice correctly." t nil)

(register-definition-prefixes "heaven-and-hell" '("heaven-and-hell-"))
